...
public interface IGameEvent {
    ...
    /// Returning -1 will make this event only able to be posted manually to the event bus through <see cref="GameEventManager.PostEvent(Goodot15.Scripts.Game.Controller.Events.IGameEvent)"/>
    /// </summary>
    ...
    /// <summary>
    /// Called when the event is triggered; Happens either automatically by the <see cref="GameEventManager"/> or manually when posted through the eventbus with <see cref="GameEventManager.PostEvent(Goodot15.Scripts.Game.Controller.Events.IGameEvent)"/>
    /// </summary>
