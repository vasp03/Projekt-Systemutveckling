...
public class Altar() : Card("Alter_0", true), ICardConsumer, ITickable {
    ...
    private int totalVillagersSacrificed = 0;
    private bool playedSound = false;
    public override int Value => -1;

    private Texture2D stage0 = GD.Load<Texture2D>("res://Assets/Cards/Ready To Use/Alter_0.png");
    private Texture2D stage1 = GD.Load<Texture2D>("res://Assets/Cards/Ready To Use/Alter_1.png");
    private Texture2D stage2 = GD.Load<Texture2D>("res://Assets/Cards/Ready To Use/Alter_2.png");
    private Texture2D stage3 = GD.Load<Texture2D>("res://Assets/Cards/Ready To Use/Alter_3.png");
    private Texture2D stage4 = GD.Load<Texture2D>("res://Assets/Cards/Ready To Use/Alter_4.png");
    ...
    public bool ConsumeCard(Card otherCard) {
        ...
        GameController.Singleton.CameraController.Shake(totalVillagersSacrificed, Utilities.TimeToTicks(seconds: 0.75d));
        ...
        } else if (totalVillagersSacrificed > TOTAL_SACRIFICES_REQUIRED * 0.25 && totalVillagersSacrificed <= TOTAL_SACRIFICES_REQUIRED * 0.67) {
            CardNode.UpdateCardTexture(stage2, true);
        } else if (totalVillagersSacrificed > TOTAL_SACRIFICES_REQUIRED * 0.5 && totalVillagersSacrificed < TOTAL_SACRIFICES_REQUIRED) {
            CardNode.UpdateCardTexture(stage3, true);
        } else if (totalVillagersSacrificed >= TOTAL_SACRIFICES_REQUIRED) {
            CardNode.UpdateCardTexture(stage4, true);
        }
